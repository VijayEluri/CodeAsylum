...
public class TestExecutor implements ExchangeListener {
  ...
  public TestExecutor (TestPlan testPlan)
    throws RemoteException {

    this.testPlan = testPlan;

    exchangeTransport = new ExchangeTransportImpl();
    ...
    public void run () {
      ...
      try {
        ...
        try {
          ...
          exception = (exception == null) ? remoteException : (RemoteException)remoteException.initCause(exception);
        }
        finally {
          terminationLatch.countDown();
        }
