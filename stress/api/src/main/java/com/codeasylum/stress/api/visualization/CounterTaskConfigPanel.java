...
import com.codeasylum.stress.api.CounterTask;
import com.codeasylum.stress.api.TestPlan;

public class CounterTaskConfigPanel extends JPanel implements DocumentListener {

  private TestPlan testPlan;
  private CounterTask task;
  private JTextField keyTextField;

  public CounterTaskConfigPanel (TestPlan testPlan, CounterTask task) {
    ...
    numericalEditingPanel = new NumericalAttributeEditingPanel(testPlan, task.getStartAttribute());
    numericalEditingPanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Start"), BorderFactory.createEmptyBorder(5, 5, 5, 5)));
