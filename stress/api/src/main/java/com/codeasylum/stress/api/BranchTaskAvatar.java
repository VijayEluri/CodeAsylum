...
public class BranchTaskAvatar extends AbstractTaskAvatar<BranchTask> {
  ...
  @Override
  public JComponent getVisualization (JFrame parentFrame, TestExecutor testExecutor, BranchTask task) throws Exception {

    return new BranchTaskConfigPanel(testExecutor.getTestPlan(), task);
  }
}
