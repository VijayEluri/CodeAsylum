...
public class DebugWriterTaskAvatar extends AbstractTaskAvatar<DebugWriterTask> {
  ...
  @Override
  public JComponent getVisualization (JFrame parentFrame, TestExecutor testExecutioner, DebugWriterTask task)
    throws Exception {

    return new DebugWriterTaskConfigPanel(testExecutioner.getTestPlan(), task);
  }
}
