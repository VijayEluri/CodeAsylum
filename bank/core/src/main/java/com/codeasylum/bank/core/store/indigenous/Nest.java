...
public class Nest {
  ...
  public void push (Field field) {
    ...
    elements.add(new Element(field));
  }
  ...
  public String toString () {
    ...
    if (!elements.isEmpty()) {
      for (Element element : elements) {
          ...
          Field field;
          pathBuilder.append(((field = element.getField()) == null) ? "root" : field.getName());

          pathBuilder.append(element.getChildren());
          first = false;
      }
    }
